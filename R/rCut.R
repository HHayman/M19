...
rCut <- function(Data, CSS, OS, PFS, DFS, minprop="0.1", maxprop="0.9", PlotPalette="SPSS", ID, Survival="Survival", SurvivalStatus="SurvivalStatus", Progression="Progression", ProgressionStatus="ProgressionStatus", DiseaseFree="DiseaseFree", DiseaseFreeStatus="DiseaseFreeStatus", Variables)
{
  ...
  if (PlotPalette == "SPSS") {
    ...
    if (CSS == "Yes") {
      CSS.res.cut <- surv_cutpoint(Data, time = "Survival", event = "CSS", minprop = minprop, maxprop = maxprop, Variables)
      ...
      for (i in 1:n) {
        ...
        CSS.res.cut <- surv_cutpoint(Data, time = "Survival", event = "CSS", minprop = minprop, maxprop = maxprop, Variables[i])
    ...
    if (OS == "Yes") {
      OS.res.cut <- surv_cutpoint(Data, time = "Survival", event = "OS", minprop = minprop, maxprop = maxprop, Variables)
      ...
      for (i in 1:n) {
        ...
        OS.res.cut <- surv_cutpoint(Data, time = "Survival", event = "OS", minprop = minprop, maxprop = maxprop, Variables[i])
    ...
    if (PFS == "Yes") {
      PFS.res.cut <- surv_cutpoint(Data, time = Progression, event = ProgressionStatus, minprop = minprop, maxprop = maxprop, Variables)
      ...
      for (i in 1:n) {
        ...
        PFS.res.cut <- surv_cutpoint(Data, time = "Progression", event = "ProgressionStatus", minprop = minprop, maxprop = maxprop, Variables[i])
    ...
    if (DFS == "Yes") {
      DFS.res.cut <- surv_cutpoint(Data, time = DiseaseFree, event = DiseaseFreeStatus, minprop = minprop, maxprop = maxprop, Variables)
      ...
      for (i in 1:n) {
        ...
        DFS.res.cut <- surv_cutpoint(Data, time = "DiseaseFree", event = "DiseaseFreeStatus", minprop = minprop, maxprop = maxprop, Variables[i])
