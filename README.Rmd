...
For 'Survival', 'SurvivalStatus', 'Progression' and 'ProgressionStatus', replace the text within the quotation marks with your variable names. 

If you are not using PFS, delete the 'Progression' and 'ProgressionStatus' arguments, and likewise for CSS/OS if you want neither, but keep it if you want one or the other.
